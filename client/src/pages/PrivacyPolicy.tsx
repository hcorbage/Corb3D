      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed mb-3">Durante o uso do sistema, coletamos as seguintes categorias de dados:</p>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">3. Base Legal para o Tratamento</h2>
            <p className="text-sm leading-relaxed mb-3">O tratamento dos dados pessoais é realizado com as seguintes bases legais (art. 7º da LGPD):</p>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">4. Finalidade do Tratamento</h2>
            <p className="text-sm leading-relaxed mb-3">Os dados coletados são utilizados para:</p>
            <ul className="text-sm leading-relaxed space-y-1.5 list-disc pl-5">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">6. Armazenamento e Segurança</h2>
            <p className="text-sm leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">7. Retenção de Dados</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed mt-3">
              Para exercer qualquer desses direitos, entre em contato com o suporte via WhatsApp.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">9. Cookies e Sessões</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">11. Encarregado de Dados (DPO)</h2>
            <p className="text-sm leading-relaxed">
              O responsável pelo tratamento dos dados pessoais no âmbito desta plataforma é o administrador da plataforma C3D Manager®. Para dúvidas, solicitações ou reclamações relacionadas à privacidade e ao tratamento de dados, entre em contato através do nosso suporte via WhatsApp.
            </p>
          </section>

          <div className="pt-4 border-t border-gray-100 text-xs text-gray-400 text-center">
            C3D Manager® — Política de Privacidade — Versão {TERMS_VERSION} — Última atualização: {TERMS_DATE}
          </div>
        </div>
      </div>
    </div>
